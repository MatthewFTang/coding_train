...
class DotsArray {
    ...
    makeDots() {
        while (this.attempts<2000 || this.dotArray.length < n_dots) {
            ...
            while (dist > (outer_radius * outer_radius) || dist < inner_radius * inner_radius || overlap) {
            ...
            this.dotArray.push({x: x, y: y, r: r, colorAngle: Math.random() * 360});
